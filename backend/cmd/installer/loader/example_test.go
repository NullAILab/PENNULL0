...
func ExampleEnvFile_workflow() {
	...
	initialContent := `# penNULL Configuration
...
API_KEY=old_key`
	...
	// DATABASE_URL = postgres://localhost:5432/db (default: postgres://pennulluser:pennullpass@pgvector:5432/pennulldb?sslmode=disable)
	// DEBUG = false
	// API_KEY = old_key
	//
	// Configuration saved successfully!
