...
import (
	...
	"pennull/cmd/installer/wizard/logger"
	"pennull/cmd/installer/wizard/styles"
	"pennull/cmd/installer/wizard/window"

	tea "github.com/charmbracelet/bubbletea"
	"github.com/nullailab/cloud/sdk"
)

// ServerSettingsFormModel represents the penNULL server settings configuration form
...
func (m *ServerSettingsFormModel) BuildForm() tea.Cmd {
	...
	fields = append(fields, m.createTextField("pennull_license_key",
	...
	// host and port
	fields = append(fields, m.createTextField("pennull_server_host",
	...
	fields = append(fields, m.createTextField("pennull_server_port",
	...
	// public url
	fields = append(fields, m.createTextField("pennull_public_url",
	...
	// cors origins
	fields = append(fields, m.createTextField("pennull_cors_origins",
	...
	// ssl dir
	fields = append(fields, m.createTextField("pennull_ssl_dir",
	...
	// data dir
	fields = append(fields, m.createTextField("pennull_data_dir",
	...
	fields = append(fields, m.createTextField("pennull_cookie_signing_salt",
