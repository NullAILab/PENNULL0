...
func (h *MaintenanceHandler) LoadItems() []ListItem {
	...
	// stop penNULL - show if any stack is running
	...
	// restart penNULL - show if any stack is running
	if showStop {
		items = append(items, ListItem{
	...
	// update penNULL - show if updates are available for any stack
	...
	// remove penNULL - show if any stack is installed
	...
	// purge penNULL - show if any stack is installed
	...
	// reset admin password - show if penNULL is running
