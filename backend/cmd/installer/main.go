...
import (
	...
	"pennull/cmd/installer/hardening"
	"pennull/cmd/installer/state"
	"pennull/cmd/installer/wizard"
	"pennull/pkg/version"
)
...
func parseFlags(args []string) Config {
	...
	flagSet.Usage = func() {
		fmt.Fprintf(os.Stderr, "penNULL Installer v%s\n\n", version.GetBinaryVersion())
...
func createInitialEnvFile(path string) error {
	...
	content = fmt.Appendf(nil, `# penNULL Environment Configuration
# Generated by penNULL Installer v%s
#
# This file contains environment variables for penNULL configuration.
...
func printStartupInfo(envPath string, checkResult checker.CheckResult) {
	fmt.Printf("penNULL Installer v%s\n", version.GetBinaryVersion())
