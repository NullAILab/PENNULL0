...
API_PORT=8080`
	...
	fmt.Println("=== penNULL Configuration Manager ===")
	...
	state.SetVar("DATABASE_URL", "postgres://prod-server:5432/pennulldb")
	...
	//
	// --- Current Configuration ---
	// DATABASE_URL: postgres://prod-server:5432/pennulldb [CHANGED]
