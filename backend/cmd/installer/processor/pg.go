...
const (
	...
	DefaultPostgreSQLDatabase = "pennulldb"

	// Admin user email
	AdminEmail = "admin@pennull.com"

	// Environment variable names
	EnvPostgreSQLUser     = "PENNULL_POSTGRES_USER"
	EnvPostgreSQLPassword = "PENNULL_POSTGRES_PASSWORD"
	EnvPostgreSQLDatabase = "PENNULL_POSTGRES_DB"
)
