# penNULL Installer Documentation

## Overview

The penNULL installer provides a robust Terminal User Interface (TUI) for configuring the application. Built using the [Charm](https://charm.sh/) tech stack (bubbletea, lipgloss, bubbles), it implements modern responsive design patterns optimized for terminal environments.
...
const MainMenuLLMProvidersInfo = `Configure AI language model providers for penNULL.
