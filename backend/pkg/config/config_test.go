...
func TestGetSecretPatterns_WithSecrets(t *testing.T) {
	cfg := &Config{
		...
		GeminiAPIKey:    "AIzaTEST1234567890abcdefghijklmnopqrst",
...
func TestGetSecretPatterns_PatternCompilation(t *testing.T) {
	testCases := []struct {
	...
	}{
		{
			name: "OpenAI",
			config: &Config{
				OpenAIKey: "sk-test-1234567890abcdefghijklmnopqrstuvwxyz",
			},
		},
		{
			name: "Anthropic",
			config: &Config{
				AnthropicAPIKey: "sk-ant-test-abcdefghijklmnopqrstuvwxyz1234567890",
			},
		},
		{
			name: "Gemini",
			config: &Config{
				GeminiAPIKey: "AIzaSy-TEST-PLACEHOLDER-NOT-REAL",
			},
		},
		{
			name: "DeepSeek",
		...
		},
		{
			name: "Google",
			config: &Config{
				GoogleAPIKey: "AIzaSy-TEST-PLACEHOLDER-NOT-REAL",
		...
		},
		{
			name: "OAuth",
			config: &Config{
				OAuthGoogleClientID:     "test-client-id.apps.googleusercontent.placeholder",
				OAuthGoogleClientSecret: "TEST_GOCSPX_PLACEHOLDER_NOT_REAL",
				OAuthGithubClientID:     "Iv1-TEST-PLACEHOLDER-00",
		...
		},
		{
			name: "Bedrock",
			config: &Config{
				BedrockAccessKey:    "AKIATEST0PLACEHOLDER01",
				BedrockSecretKey:    "wJalrTESTPlaceholderKEYnotReal0000",
				BedrockBearerToken:  "eyJhbGciOiJSUzI1NiIsInR5cCI6IkpXVCJ9.example",
				BedrockSessionToken: "FwoGTESTPLACEHOLDER1234567890FAKE",
			},
		},
		{
			name: "Langfuse",
...
func TestNewConfig_Defaults(t *testing.T) {
	...
	assert.Equal(t, "nullailab/kali-linux", config.DockerDefaultImageForPentest)
}
