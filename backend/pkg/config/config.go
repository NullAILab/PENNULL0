...
import (
	...
	"github.com/nullailab/cloud/anonymizer/patterns"
	"github.com/nullailab/cloud/sdk"
)

type Config struct {
	// === Core System Configuration ===
	DatabaseURL string `env:"DATABASE_URL" envDefault:"postgres://pennulluser:pennullpass@pgvector:5432/pennulldb?sslmode=disable"`
	Debug       bool   `env:"DEBUG" envDefault:"false"`
	DataDir     string `env:"DATA_DIR" envDefault:"./data"`
	AskUser     bool   `env:"ASK_USER" envDefault:"false"`

	// === penNULL Cloud Service Integration ===
