...
import (
	...
	"pennull/pkg/server/logger"
	"pennull/pkg/server/oauth"
	"pennull/pkg/server/services"

	_ "pennull/pkg/server/docs" // swagger docs
...
// @title penNULL Swagger API
// @version 1.0
// @description Swagger API for Penetration Testing Advanced General Intelligence penNULL.
// @termsOfService http://swagger.io/terms/

// @contact.url https://pennull.com
// @contact.name penNULL Development Team
// @contact.email team@pennull.com
...
func NewRouter(
	...
	router.Use(logger.WithGinLogger("pennull-api"))
