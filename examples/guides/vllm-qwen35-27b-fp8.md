# Running penNULL with vLLM and Qwen3.5-27B-FP8

This guide explains how to deploy penNULL with a fully local LLM setup using vLLM and Qwen3.5-27B-FP8. This configuration enables complete independence from cloud API providers while maintaining high performance for autonomous penetration testing workflows.
...
- [penNULL Integration](#pennull-integration)
...
This model is particularly well-suited for penNULL's multi-agent workflows due to its:
...
If all tests return valid JSON responses with appropriate content, your vLLM server is ready for penNULL integration.
...
These parameters are already applied in the penNULL provider configuration files referenced below.

---

## penNULL Integration

### Step 1: Configure Custom Provider in penNULL

penNULL includes pre-configured provider files for Qwen3.5-27B-FP8 with optimized sampling parameters for different agent roles.
...
### Step 2: Add Provider via penNULL UI

1. Start penNULL (see [Quick Start](../../README.md#-quick-start))
...
These benchmarks demonstrate that Qwen3.5-27B-FP8 provides excellent throughput for running multiple penNULL flows in parallel, making it suitable for production deployments.
...
- For most penNULL workflows, the native 262K context is sufficient
...
- **penNULL Main Documentation**: [README.md](../../README.md)
